...
💻 **Developer Java / Backend Software Engineer** • Arquitetura de Microsserviços • Sistemas Orientados a Eventos • Mensageria e Alta Performance

---

### 🚀 Sobre mim

Sou um desenvolvedor backend com ampla experiência em projetos de alta complexidade em empresas de grande porte. Ao longo da minha trajetória, participei ativamente desde a modernização de sistemas legados até o desenvolvimento e evolução de plataformas distribuídas, escaláveis e de alta performance.

Tenho forte vivência na criação de ecossistemas orientados a eventos, orquestração de workflows complexos e integração de microsserviços. Sou movido por boas práticas de desenvolvimento, arquitetura limpa e entrega de soluções robustas para problemas reais do negócio.
...
* **LinkedIn:** [linkedin.com/in/braulio-es-carvalho](https://www.linkedin.com/in/braulio-es-carvalho/)
* **Email:** [braulio.github@gmail.com](mailto:braulio.github@gmail.com)
